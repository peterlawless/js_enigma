...
describe("Enigma", function () {
  ...
  //         expect(() => enigma("", {})).to.throw(
  //           "input 'plainLetter' must be a single uppercase letter"
  //         );
  //       });
  //     });
  ...
  //           expect(() => enigma("A", { foo: "bar" })).to.throw(
  //             "Missing 'reflector' property in the scrambler object"
  //           );
  //         });

  //         it("should throw an error when called with an invalid value for the 'reflector' property in the scrambler object", function () {
  //           expect(() => enigma("A", { reflector: "foo" })).to.throw(
  //             "Invalid reflector model"
  //           );
  //         });
  //       });

  //       ["greekWheel", "slowRotor", "centerRotor", "fastRotor"].map(function (
  //         property
  //       ) {
  ...
  //             expect(() => enigma("A", fullscrambler)).to.throw(
  //               `Missing required \'${property}\' property from scrambler object`
  //             );
  //           });
  ...
  //             expect(() => enigma("A", fullscrambler)).to.throw(
  //               `\'${property}\' must be an instance of an Object`
  //             );
  //           });
  ...
  //               expect(() => enigma("A", fullscrambler)).to.throw(
  //                 `Missing required \'${property}.${prop}\' property from scrambler object`
  //               );
  //             });
  ...
  //               expect(() => enigma("A", fullscrambler)).to.throw(
  //                 `Invalid \'${property}.${prop}\' property in scrambler object`
  //               );
  //             });
  //           });
  //         });
  ...
  //         expect(() => enigma("A", scrambler, "foo")).to.throw(
  //           "input 'plugBoard' must be an Object"
  //         );
  //       });
